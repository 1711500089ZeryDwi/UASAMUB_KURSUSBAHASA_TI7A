...
public class PelatihanCheckoutAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Kursus").child(jenis_pelatihan_baru);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                valuehargapelatihan = Integer.valueOf(dataSnapshot.child("harga_kursus").getValue().toString());
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference3.getRef().child("nama_kursus").setValue(nama_pelatihan.getText().toString());
                        reference3.getRef().child("lokasi").setValue(location_pelatihan.getText().toString());
                        reference3.getRef().child("ketentuan").setValue(ketentuan.getText().toString());
                        reference3.getRef().child("jumlah_kursus").setValue(valuejumlahpelatihan.toString());
                        reference3.getRef().child("date_kursus").setValue(date_pelatihan);
                        reference3.getRef().child("time_kursus").setValue(time_pelatihan);
