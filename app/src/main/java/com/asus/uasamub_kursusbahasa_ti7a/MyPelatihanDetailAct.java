...
public class MyPelatihanDetailAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xnama_pelatihan = findViewById(R.id.xnama_kursus);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Kursus").child("Inggris");
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                xnama_pelatihan.setText(dataSnapshot.child("nama_kursus").getValue().toString());
                xlokasi.setText(dataSnapshot.child("lokasi").getValue().toString());
                xtime_pelatihan.setText(dataSnapshot.child("time_kursus").getValue().toString());
                xdate_pelatihan.setText(dataSnapshot.child("date_kursus").getValue().toString());
